...
interface PillRect { x: number; y: number; w: number; h: number; color: string; opacity: number }

export function renderWallpaper(canvas: HTMLCanvasElement, config: WallpaperConfig) {
...
function drawLiquidGlassBackground(
  ...
  for (const p of pills) {
    ...
    ctx.fillStyle = grad;
    ctx.fillRect(Math.max(cx - radius, 0), Math.max(cy - radius, 0), radius * 2, radius * 2);
  }
  ...
  bgGrad.addColorStop(0, mode === 'dark' ? 'rgba(255,255,255,0.025)' : 'rgba(255,255,255,0.4)');
...
function drawLiquidGlassPill(
  ...
  specGrad.addColorStop(0,   mode === 'dark' ? 'rgba(255,255,255,0.42)' : 'rgba(255,255,255,0.70)');
  specGrad.addColorStop(0.55, mode === 'dark' ? 'rgba(255,255,255,0.10)' : 'rgba(255,255,255,0.28)');
  ...
  const causticGrad = ctx.createLinearGradient(causticX, 0, causticX + causticW, 0);
  causticGrad.addColorStop(0,    'rgba(255,255,255,0)');
  causticGrad.addColorStop(0.2,  mode === 'dark' ? 'rgba(255,255,255,0.75)' : 'rgba(255,255,255,0.95)');
  causticGrad.addColorStop(0.5,  mode === 'dark' ? 'rgba(255,255,255,0.90)' : 'rgba(255,255,255,1.0)');
  causticGrad.addColorStop(0.8,  mode === 'dark' ? 'rgba(255,255,255,0.75)' : 'rgba(255,255,255,0.95)');
  causticGrad.addColorStop(1,    'rgba(255,255,255,0)');

  // Use elliptical mask for the arc shape
  ctx.save();
  ctx.beginPath();
  ctx.ellipse(x + w / 2, causticCy, causticW / 2, causticThk * 2.2, 0, 0, Math.PI * 2);
  ...
  const caustic2Grad = ctx.createLinearGradient(x + (w - caustic2W) / 2, 0, x + (w + caustic2W) / 2, 0);
  caustic2Grad.addColorStop(0,   'rgba(255,255,255,0)');
  caustic2Grad.addColorStop(0.5, mode === 'dark' ? 'rgba(255,255,255,0.5)' : 'rgba(255,255,255,0.65)');
  caustic2Grad.addColorStop(1,   'rgba(255,255,255,0)');
  ctx.save();
  ctx.beginPath();
  ctx.ellipse(x + w / 2, caustic2Cy, caustic2W / 2, caustic2Thk * 1.8, 0, 0, Math.PI * 2);
  ...
  shadowGrad.addColorStop(1, mode === 'dark' ? 'rgba(0,0,0,0.18)' : 'rgba(0,0,0,0.07)');
  ...
  rimGrad.addColorStop(0,   mode === 'dark' ? 'rgba(255,255,255,0.60)' : 'rgba(255,255,255,0.92)');
  rimGrad.addColorStop(0.35, mode === 'dark' ? 'rgba(255,255,255,0.22)' : 'rgba(255,255,255,0.55)');
  rimGrad.addColorStop(0.7,  mode === 'dark' ? 'rgba(255,255,255,0.08)' : 'rgba(255,255,255,0.25)');
  rimGrad.addColorStop(1,   mode === 'dark' ? 'rgba(255,255,255,0.04)' : 'rgba(255,255,255,0.12)');

  ctx.strokeStyle = rimGrad;
  ctx.lineWidth = Math.max(1.5 * scale, 1);
  const inset = ctx.lineWidth / 2;
  ctx.beginPath();
  ctx.roundRect(x + inset, y + inset, w - inset * 2, h - inset * 2, Math.max(r - inset, 0));
  ctx.stroke();
